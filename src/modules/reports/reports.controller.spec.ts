...
describe("ReportsController", () => {
  ...
  const mockReportsService = {
    getSalesReport: jest
      .fn()
      .mockResolvedValue({ summary: {}, pagination: {}, data: [] }),
    getPurchaseReport: jest
      .fn()
      .mockResolvedValue({ summary: {}, pagination: {}, data: [] }),
    getProfitReport: jest
      .fn()
      .mockResolvedValue({ summary: {}, pagination: {}, data: [] }),
    getStockReport: jest
      .fn()
    ...
    getStockLedger: jest
      .fn()
      .mockResolvedValue({ summary: {}, pagination: {}, data: [] }),
    getCustomerOutstanding: jest
      .fn()
      .mockResolvedValue({ summary: {}, pagination: {}, data: [] }),
    getSupplierOutstanding: jest
      .fn()
      .mockResolvedValue({ summary: {}, pagination: {}, data: [] }),
    getPaymentReport: jest
      .fn()
      .mockResolvedValue({ summary: {}, pagination: {}, data: [] }),
    getExpenseReport: jest
      .fn()
      .mockResolvedValue({ summary: {}, pagination: {}, data: [] }),
    getGstSummary: jest
      .fn()
      .mockResolvedValue({ summary: {}, pagination: {}, data: [] }),
    getDailySalesReport: jest
      .fn()
      .mockResolvedValue({ summary: {}, pagination: {}, data: [] }),
    getMonthlySalesReport: jest
      .fn()
      .mockResolvedValue({ summary: {}, pagination: {}, data: [] }),
    getTopProductsReport: jest
      .fn()
      .mockResolvedValue({ summary: {}, pagination: {}, data: [] }),
    getLowStockReport: jest
      .fn()
      .mockResolvedValue({ summary: {}, pagination: {}, data: [] }),
  };
  ...
  const mockExcelService = {
    ...
    exportReportToExcel: jest
      .fn()
      .mockResolvedValue(Buffer.from("fake-report-excel")),
  };
