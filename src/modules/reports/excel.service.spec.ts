  ...
  const mockPrisma = {
      ...
      findMany: jest.fn().mockResolvedValue([
        {
          ...
          stockBalances: [{ quantity: 50, warehouse: { name: 'Main Warehouse' } }],
          prices: [
    ...
    $transaction: jest.fn().mockImplementation(async (callback) => {
      const tx = {
        ...
        category: {
          findFirst: jest.fn().mockResolvedValue(null),
          create: jest.fn().mockResolvedValue({ id: 'c-1', name: 'Electronics' }),
        },
        brand: {
          findFirst: jest.fn().mockResolvedValue(null),
        ...
        product: {
          findFirst: jest.fn().mockResolvedValue(null),
          create: jest.fn().mockResolvedValue({ id: 'new-p-1', productCode: 'PRD-002', sku: 'SKU-002' }),
